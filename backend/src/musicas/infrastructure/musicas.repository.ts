...
import { MusicaDocument, MusicaMongoDocument } from '@shared/infrastructure/database/mongo-schemas';
...
export class MusicasRepository {
  constructor(@InjectModel(MusicaDocument.name) private model: Model<MusicaMongoDocument>) {}
