    ...
    <div className="min-h-screen pt-20 px-6 pb-8 bg-gradient-to-b from-[var(--love-bg-start)] to-[var(--love-bg-end)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 max-w-[1200px] mx-auto">
        {cartas.map((carta) => (
          ...
          >
            <div className="text-love-primary text-sm mb-4">
      ...
      {cartaSelecionada && (
        ...
        >
          ...
          >
            <h2 className="text-love-primary text-2xl font-[Dancing_Script] mb-4">{cartaSelecionada.titulo}</h2>
            <div className="text-love-primary text-sm mb-6">
